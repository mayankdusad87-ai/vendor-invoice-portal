  ...
  return (
    <div className="max-w-5xl mx-auto">
        <div className="admin-page-header">
          <div>
            <h2>Accounts Team</h2>
            <p>{activeMembers.length} active member(s)</p>
          </div>
          {!showForm && (
            <button
              ...
              <div key={member.id} className="card">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    <button onClick={() => openProjectAssignment(member)} className="action-link action-link-primary">
                      Projects
                    </button>
                    <button onClick={() => handleEdit(member)} className="action-link action-link-primary">
                      Edit
                    </button>
                    <button onClick={() => handleToggleStatus(member)} className="action-link action-link-danger">
                      Deactivate
                    </button>
                  </div>
                </div>
                ...
                {inactiveMembers.map((member) => (
                  <div key={member.id} className="card" style={{ opacity: 0.6 }}>
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={() => handleToggleStatus(member)} className="action-link action-link-success">
                        Reactivate
                      </button>
                    </div>
                  </div>
